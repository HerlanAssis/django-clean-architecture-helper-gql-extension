...
name = 'clean_architecture_helper_gql_extension'
...
setup(
    name='django-clean-architecture-helper-gql-extension',
    version='0.1',
    license='BSD License',  # example license
    description='Django Clean Architecture Helper Graphql Extension',
